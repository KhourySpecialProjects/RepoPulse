...
export function ContextualActivityChart({ collectionId, repoId, children, actions }: { collectionId: string; repoId: string; children?: ReactNode; actions?: ReactNode }) {
  ...
  const authorLabel = student?.name ?? 'All students'
